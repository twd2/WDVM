main: main.o CPU.o CPU_Registers.o CPU_Instructions.o Memory.o Machine.o InterruptInfo.o BinaryHelper.o ParameterInfo.o InstructionInfo.o
	g++ -O2 -o wdvm BinaryHelper.o main.o InterruptInfo.o CPU.o CPU_Registers.o CPU_Instructions.o Memory.o Machine.o  ParameterInfo.o InstructionInfo.o
main_static: main
	g++ -O2 -static -o wdvm BinaryHelper.o main.o InterruptInfo.o CPU.o CPU_Registers.o CPU_Instructions.o Memory.o Machine.o  ParameterInfo.o InstructionInfo.o
...
clean: 
	-rm wdvm wdvm_static main.o CPU.o CPU_Registers.o CPU_Instructions.o InterruptInfo.o Memory.o Machine.o BinaryHelper.o ParameterInfo.o InstructionInfo.o *.gch
release: main
	make
	-mkdir release
	cp wdvm release/
